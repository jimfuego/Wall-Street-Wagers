        ...
        Meteor.call("wager.updatechallengeestate", this.state.statechange, this.props.challenger[0]._id, (err, res) => {
            if (err) {
                ...
                this.props.history.push({
                    ...
                    state: {
                        thechallenger: this.props.challenger[0].challenger,
                ...
                <div className="yourChallenges">
                    <div className="body">
                        <div className="row">
                            ...
                            <Button id="accept" variant="outlined" color="primary" style={{textTransform: "none"}}
                                    onClick={this.onClick}>Accept</Button>
                            <Button id="decline" variant="outlined" color="primary" style={{textTransform: "none"}}
                                    onClick={this.buttonClicked}>Decline</Button>
                        </div>
                    </div>
                </div>
            </div>
